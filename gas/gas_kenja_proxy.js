...
function buildPrompt(secCode, name, scores, edinetData, dataSource) {
  ...
  return 'あなたは「賢者」です。プロの証券アナリストであり、投資教育者です。\n'
    ...
    + '  "partA": {\n'
    + '    "businessResults": {"score":1-5,"title":"鋭いタイトル","summary":"8-12文。売上の増減理由、利益の増減理由、最も好調な事業と最も不調な事業を具体的に。"},\n'
    + '    "growthQuality": {"score":1-5,"title":"...","summary":"8-12文。成長エンジンの正体（数量増/値上げ/M&A等）。営業利益率の変化と理由。"},\n'
    + '    "sustainability": {"score":1-5,"title":"...","summary":"8-12文。構造的か一過性か。外部依存度と具体的リスク。"},\n'
    + '    "outlook": {"score":1-5,"title":"...","summary":"8-12文。公式予想の具体数値。経営陣の温度感と根拠。"},\n'
    + '    "defense": {"score":1-5,"title":"...","summary":"8-12文。上位2-3リスクを名指し。対策の有無。"},\n'
    + '    "cashFlow": {"score":1-5,"title":"...","summary":"8-12文。営業CF・投資CF・FCFの具体金額。"},\n'
    + '    "finalVerdict": {"credibility":"high" or "medium" or "low","reasons":["reason1","reason2","reason3"]}\n'
    + '  },\n'
    + '  "partB": {\n'
    + '    "overview":"15-20文の詳細分析。売上・利益の具体的な増減額と前年比%を記載。最も好調なセグメントと最も不調なセグメントを名指しで特定し、それぞれの理由を深掘り。会社の意気込みや経営方針にも言及すること。",\n'
    + '    "growth":"15-20文。成長エンジンの正体を徹底解剖。新製品なのか、値上げなのか、数量増なのか、M&Aなのか、為替なのかを特定。営業利益率の変化（前年→当年の具体的%）とその理由。この会社だけの独自の強み・競争優位性は何か。業界全体のトレンドの中でこの会社がどう位置付けられるか。",\n'
    + '    "sustainability":"15-20文。構造的成長か一過性か。SaaSなら継続課金の積み上げ型か。外部依存度（為替・特定顧客・特定プラットフォーム・政策等）の具体的なリスク。同業他社と比較した場合のポジション。この成長モメンタムが今後3-5年続く根拠があるか。",\n'
    + '    "future":"15-20文。会社発表の業績予想（次期の売上・利益の具体的な数値と前年比%）。経営陣の温度感を具体的なコメントや施策から読み取る。人材投資・広告投資・M&A戦略など、経営陣が何に賭けているか。予想の透明度と達成可能性の評価。",\n'
    + '    "defense":"15-20文。上位2-3リスクを具体的に名指し。①競争環境のリスク（競合は誰か、どう攻めてきているか）②事業構造のリスク（特定顧客依存、プラットフォーム依存等）③外部環境のリスク（規制・為替・景気）。それぞれに対する会社の対策の有無と十分性。投資家として最も気を付けるべき1点。",\n'
    + '    "cashflow":"15-20文。営業CF・投資CF・財務CF・フリーCFの具体的な金額。現金創出力は本業から生まれているか。設備投資は成長に見合っているか、過大か過小か。配当・自社株買い等の株主還元策。手元現金の水準と財務安全性。有利子負債の状況。",\n'
    + '    "conclusion":"15-20文。50代投資初心者への本音のアドバイス。この会社の勝ち筋は信頼できるか。今買うべきか、待つべきか、見送るべきか。スコアとの乖離があれば警告。長期保有の観点からの最終判断。初心者が見落としがちなポイント。"\n'
    + '  },\n'
    + '  "alert": "v4.3スコアと直近の実態に乖離がある場合、1-2文で警告。なければnull。",\n'
    + '  "beginnerAdvice": "50代投資初心者への8-10文の丁寧なアドバイス。この会社に投資する価値があるか、注意すべき点は何か、どのような局面で買うべきか。専門用語には必ず括弧内に説明を。"\n'
    + '}\n'
    + '\n重要ルール:\n'
