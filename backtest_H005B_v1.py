...
【仮説】VIX>=30時（暴落時）に買い5年保有すると、通常時より高リターンを得られる
【登録】2026/03/29 / Bonferroni補正 α=0.025
【結果】5年保有：ADOPTED（PANIC+21.81%/yr vs CALM+13.01%/yr / 差+8.80% / p=0.0035）
        3年保有：REJECTED（差+1.85% / p=0.218）
        → 細矢さんの「暴落時こそ買い場」がデータで裏付けられた
        → H001-C「5年保有で勝率100%」と完全整合
【実行】python backtest_H005B_v1.py（ローカル実行可）
【依存】FRED_API_KEY（環境変数）/ yfinance（日経225データ）
【データ】2007-2024（リーマン・コロナ・2022暴落含む）
         パニック月（VIX>=30）：19ヶ月
"""
# backtest_H005B_v1.py
# H005-B: 暴落時買い戦略の有効性バックテスト
