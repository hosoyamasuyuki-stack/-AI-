...
function buildPrompt(secCode, name, scores, edinetData) {
  ...
  return 'You are "The Sage" - a professional securities analyst and investment educator.\n'
    ...
    + '\n'
    + '5. RISKS - Identify top 2-3 risks with severity (high/medium/low).\n'
    + '   Does the company have countermeasures?\n'
    + '\n'
    ...
    + '    "risks": {"level":"high" or "medium" or "low","title":"...","summary":"2-3 sentences. Top risk and countermeasure."},\n'
    ...
    + '    "risks":"3-5 sentences. What could go wrong?",\n'
